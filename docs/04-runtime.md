...
- For more examples, see the tests in [imported/src/commonTest/kotlin/ParserTest.kt](https://github.com/MirrgieRiana/kotlin-peg-parser/blob/main/imported/src/commonTest/kotlin/ParserTest.kt).
