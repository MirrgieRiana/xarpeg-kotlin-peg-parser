...
private object ArithmeticParser {
    ...
    // Parse a grouped expression with parentheses - using ref for forward reference
    val grouped: Parser<LazyValue> = -'(' * ref { expr } * -')' map { it }
    ...
    // Forward declaration for recursive grammar - expr references sum which is defined below grouped
