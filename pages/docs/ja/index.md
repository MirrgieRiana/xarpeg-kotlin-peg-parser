...
**学習内容：** 例外の種類、`DefaultParseContext`によるエラー追跡、メモ化制御、デバッグ技法
...
### 7. [識別子デリミタ文字列](07-identifier-delimited-strings.html)
解析中に得た識別子をデリミタとして使う動的な文字列解析を学びます。

**学習内容：** `Parser { }` コンストラクタによる動的パーサ生成、XML要素やヒアドキュメントの解析、静的パーサと動的パーサの使い分け
